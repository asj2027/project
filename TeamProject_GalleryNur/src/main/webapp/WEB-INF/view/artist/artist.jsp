    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 text-center" id="artist">
            <c:forEach var="artist" items="${artist}" varStatus="status">
                <div class="artistList col-sm-6 col-md-6 col-xs-12 col-lg-4" data-aos="fade-down-right" data-aos-duration="1000" onclick=document.location.href="./artist/detail/${artist.id}">
