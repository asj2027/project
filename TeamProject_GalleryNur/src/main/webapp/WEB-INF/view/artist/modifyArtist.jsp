    ...
    <div class="container">
        <div class="row mb-2 py-4">
            <form
                    ...
                    id="frmAdd"
                    method="POST"
                    action="/artist/modify/${artist.id}"
            ...
            >
                <div class="col-6">
                    ...
                    <textarea
                            ...
                            rows="30"
                            cols="50"
                            placeholder="아티스트의 방향성에 대해 입력해주세요"
                    >
                        ${artist.direction}
                    </textarea
                    >
                    ...
                    <div class="text-end">
                        ...
                        <button
                                ...
                                onclick="location.href='/artist/detail/${artist.id}'"
                        >
                            취소
                        </button>
                    </div>
