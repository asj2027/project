...
<main class="container p-5 text-center">
    ...
    <c:forEach var="exhibit" items="${exhibit}">
        <div class="col-sm-12 col-md-12 col-xs-12 col-lg-12" data-aos="fade-up" data-aos-duration="1000">
            <a href="/exhibit/detail/${exhibit.id}"><img src="${exhibit.images}" class="img-fluid" alt="전시회 이미지"></a>
            <br><br>
            <p class="exhibit-name"><a href="/exhibit/detail/${exhibit.id}">${exhibit.name} / ${exhibit.startDate}
                ~ ${exhibit.endDate}</a><span class="artist-name" style="float:right;">${exhibit.artist}</span>
            </p>
        </div>
        <br><br>
    </c:forEach>
