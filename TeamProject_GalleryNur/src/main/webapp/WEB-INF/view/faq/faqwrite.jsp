...
<main class="container p-5">
    ...
    <form calss="row py-4" id="add" method="POST" action="/faqwrite">
        <div class="col"><br><br>
            ...
            <h3>QUESTION</h3><textarea name="question" class="form-control" id="editorq" rows="30" cols="50"></textarea>
            <br><br>
            <h3>ANSWER</h3></div>
        <textarea name="answer" class="form-control" id="editora" rows="30" cols="50"></textarea> <br><br>
    ...
    $(document)
        .on('click', '#clear', function () {
            if (confirm("작성을 완료하시겠습니까?")) {
                ...
                if (editorq != "" && !editorq.eq("") && editora != "" && !editora.eq("")) {
                    alert("작성을 완료하였습니다.");
                    return true;
                } else {
