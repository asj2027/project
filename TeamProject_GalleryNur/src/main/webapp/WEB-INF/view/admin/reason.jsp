...
<head>
    ...
    <title>탈퇴 사유 분석 - Gallery nur</title>
</head>
<style>
    table {
...
<main class="container p-5">
    ...
    <p></p>
    <div class="container">
        <canvas id="reasonChart" class="col-12 text-center" height="300rem;">
        ...
        .ready(function () {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    let cntArray = new Array();
                    for (let i = 0; i < data.length; i++) {
                        let reason = data[i];
                        reasonArray[i] = reason['reason'];
                        cntArray[i] = reason['cnt'];
                    }
                    console.log(data);
                    console.log("데이터 꺼내기 " + reasonArray);
                    console.log("데이터 꺼내기 " + cntArray);
                    let pieChart = {
                        labels: [reasonArray[0], reasonArray[1], reasonArray[2], reasonArray[3], reasonArray[4]],
                        datasets: [{
                            data: [cntArray[0], cntArray[1], cntArray[2], cntArray[3], cntArray[4]],
                            backgroundColor: ['rgb(255,99,132)', 'rgb(255,159,64)', 'rgb(255,205,86)', 'rgb(75,192,132)', 'rgb(54,162,235)']
                        }]
                    };
                    let option = {
                        plugins: {
                    ...
                    let pieChartDraw = function () {
                        let ctx = document.getElementById("reasonChart").getContext('2d');
