...
<head>
    ...
    />
    <meta name="description" content="Gallery Nur의 홈페이지입니다."/>
    <title>Gallery Nur</title>
</head>
<style>
    #main {
        font-size: 75px;
...
<main class="container">
    ...
    >
        <div class="carousel-inner">
            <c:forEach var="exhibit" items="${exhibits}" begin="0" varStatus="status">
                <c:if test="${status.index eq 0}">
                    <div class="carousel-item active" data-bs-interval="2000">
                        <a href="/exhibit/detail/${exhibit.id}">
