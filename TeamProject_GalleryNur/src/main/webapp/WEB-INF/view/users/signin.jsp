...
<main class="p-5">
    ...
    <main class="container">
        <form:form name="frm" id="frmAdd" action="/signin" method="POST" modelAttribute="userSign">
            <div>
                <p>
                    <label class="col-4 text-end">ID : </label>
                    <form:input path="id" name="id" class="col-8" placeholder="ID를 입력해주세요." style="width:40%;"/>
                </p>
                ...
                <p>
                    ...
                    <form:password path="password" name="pwd" class="col-8" id="floatingPassword" style="width:40%;"
                ...
                <p>
                    ...
                    <form:password path="passwordCheck" name="pwd2" class="col-8" style="width:40%;"
                ...
                <p>
                    ...
                    <form:input path="name" name="name" class="col-8" style="width:40%;" placeholder="이름을 입력해주세요."/>
                </p>
                <p class="col-12 text-center">
                ...
                <p>
                    ...
                    <form:input path="email" name="email" class="col-8" id="floatingemail" style="width:40%;"
                ...
                <p>
                    ...
                    <form:input path="postcode" name="postcode" class="col-8" style="width:40%;" id="sample6_postcode"
                                readonly="true" placeholder="POST CODE"/>
                </p>
                <p class="col-12 text-center">
                ...
                <p>
                    ...
                    <form:input path="address" name="adress" id="sample6_address" class="col-8" style="width:40%;"
                ...
                <p>
                    ...
                    <form:input path="dtaddress" name="dtaddress" id="sample6_detailAddress"
                                class="col-4" placeholder="상세주소" style="width:20%;"/>
                    <form:input path="refAddress" class="col-4" style="width:20%;" id="sample6_extraAddress"
                ...
                <p>
                    ...
                    <form:input path="mobile" name="mobile" class="col-8" style="width:40%;"
                                placeholder="'-' 를 제외한 전화번호를 입력해주세요." onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"/>
                </p>
                <p class="col-12 text-center">
                    <form:errors path="mobile" class="FieldError"/>
                </p>
                <p class="col-9 text-end">
                    <button type="submit" name="updateBtn" id="updateBtn" class="btn btn-dark">회원 가입</button>
                </p>
            </div>
        </form:form>
    </main>
...
<script>
    $(document)
        .on('click', '#updateBtn', function () {
            if ((frm.id.value == "") || (frm.pwd.value == "") || (frm.pwd2.value == "") || (frm.name.value == "") || (frm.email.value == "") || (frm.postcode.value == "") || (frm.address.value == "") || (frm.dtaddress.value == "") || (frm.mobile.value == "")) {
