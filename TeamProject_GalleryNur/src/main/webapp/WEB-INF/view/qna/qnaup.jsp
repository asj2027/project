    ...
    <div class="row py-4">
        <form id="frmAdd" action="upqna" method="post">
            ...
            <div class="col text-end">
                <button type="submit" class="btn btn-outline-primary" id="btnUp">
                    수정 완료
                </button>
                <button
                        type="button"
...
<script>
    ...
    $("#btnUp").click(function () {
        ...
        let titleByteLength = (function (s, b, i, c) {
            for (b = i = 0; c = s.charCodeAt(i++); b += c >> 11 ? 3 : c >> 7 ? 2 : 1) ;
            return b;
        })($("#title").val());
        if (titleByteLength > 300) {
            alert("제목은 300바이트 이상 입력할 수 없습니다");
            return false;
        }
        alert("게시글이 수정되었습니다.");
        return true;
    ...
    $(document)
        .on('click', '#btnCan', function () {
            if (confirm("수정을 취소하시겠습니까?")) {
                ...
                document.location.href = '/detail?id=' +${qdto.id};
            } else {
                return false;
            }
        })
