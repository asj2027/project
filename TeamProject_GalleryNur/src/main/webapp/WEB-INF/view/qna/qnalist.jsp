...
<main class="container p-5">
    ...
    <div class="container" id="boardList">
        <div class="row">
                    ...
                    <c:when test="${!empty qnalist}">
                        <c:forEach items="${qnalist}" var="list">
                            <tr class="text-center">
                                <td>${list.id}</td>
                                <td style="width:60%;"><a
                                        href="detail?id=${list.id}&sort=${paging.sort}&type=${paging.type}&keyword=${paging.keyword}">${list.title}</a>
                                </td>
                                <td>${list.userid}</td>
                                <td>${list.postdate}</td>
                                <td>${list.views}</td>
            ...
            <nav aria-label="Page navigation example">
                <ul class="pagination">
                    <li class="page-item">
                        <a class="page-link"
                           href="qna?curPage=1&sort=${paging.sort}&type=${paging.type}&keyword=${paging.keyword}"
                           aria-label="Previous">
                    ...
                    <c:forEach begin="${paging.firstPage}" end="${paging.lastPage}" var="i">
                        <li class="page-item"><a class="page-link"
                                                 href="qna?curPage=${i}&sort=${paging.sort}&type=${paging.type}&keyword=${paging.keyword}">
                    ...
                    <li class="page-item">
                        <a class="page-link"
                           href="qna?curPage=${paging.totalPageCount}&sort=${paging.sort}&type=${paging.type}&keyword=${paging.keyword}"
                           aria-label="Next">
        ...
        <div class="col-12 text-end">
            <button type="button" class="btn btn-outline-dark btn-sm" onclick="location.href='new'">글쓰기</button>
        </div>
    </div>
    </div>
</main>
