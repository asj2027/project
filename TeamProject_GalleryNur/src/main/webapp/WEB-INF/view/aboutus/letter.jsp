    ...
    <div class="container">
        ...
        <div class="inner clearfix">
            ...
            <section class="right-area" data-mh="matchArea" style="height: 700px">
                <p>
                    <spring:message code="letter.info"></spring:message>
                </p>
                <strong class="sign"><spring:message code="letter.director"></spring:message>
                    <br>Mr.Back<br><br><spring:message code="letter.date"></spring:message></strong>
            </section>
        </div>
    </div>
</main>
