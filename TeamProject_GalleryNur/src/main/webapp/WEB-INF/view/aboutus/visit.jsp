...
<main class="container p-5">
    <div class="page-title">
        <h1><spring:message code="Visit"></spring:message></h1>
    </div>
    <div class="row mb-2" style="height: 700px">
        <div class="col-6">
            <h2>
                Gallery Nur <br/>
                <spring:message code="Visit"></spring:message> <br/><br/>
        ...
        <div class="col-6">
            ...
            <div class="container">
                <dl class="row py-5">
                    <dt class="col-sm-3"><spring:message code="address"></spring:message></dt>
                    <dd class="col-sm-9"><spring:message code="letter.address"></spring:message></dd>
                    <dt class="col-sm-3">TEL</dt>
                    <dd class="col-sm-9">
                        <p>041-561-1122</p>
                    </dd>
                    <dt class="col-sm-3"><spring:message code="Visit"></spring:message></dt>
                    <dd class="col-sm-9">
                        <p>
                            <spring:message code="letter.visit"></spring:message>
                        </p>
                    </dd>

                    <dt class="col-sm-3"><spring:message code="use"></spring:message></dt>
                    <dd class="col-sm-9">
                        <p><spring:message code="letter.use"></spring:message></p>
                    </dd>

                    <dt class="col-sm-3"><spring:message code="Closed"></spring:message></dt>
                    <dd class="col-sm-9">
                        <p>
                            <spring:message code="letter.exit"></spring:message>
                        </p>
                    </dd>
                </dl>
            </div>
